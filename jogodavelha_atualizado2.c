...
/* Fazendo um jogo: o jogo da velha, para o projeto de TÈcnicas e Desenvolvimento de Algortimos */
...
int main(int argc, char *argv[]) {
	...
	switch(numero){
		...
		case 3:{
			printf("\n \t CR…DITOS \n");
			printf("\n ¿s alunas do Curso CiÍncia da ComputaÁ„o: Anna Maria Albino, Maria Eduarda ZumbÈ e Milena Azevedo. \n ");
			if (solicitarRetornoAoMenu()) {
            menu(&numero);
            } else {
            printf("Ok\n");
