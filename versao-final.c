	...
	int loop = 1;
		...
		switch(numero){
			case 1:{
				...
				do{ // repetir atÈ alguÈm ganhar ou dar velha
					// imprimir o jogo
					printf("\n\n\t 0   1   2\n\n");
					for(l=0; l<3; l++){
						for(c=0; c<3; c++){
					...
					do{
						...
						printf("\nJOGADOR %d: Digite a linha e a coluna que deseja jogar (observaÁ„o: dÍ um espaÁo entre os n˙meros): ", jogador);
			...
			case 2:{
                ...
                printf("Jogador 1: %d vitÛria(s)\n", jogadores[0].vitorias);
                printf("Jogador 2: %d vitÛria(s)\n", jogadores[1].vitorias);
				break;
			}
			case 3:{
				printf("\n\t\t\t\tCREDITOS\n\n");
				...
				printf("\n\tAlunas do UNIPE - Ciencia da Computacao\n");
