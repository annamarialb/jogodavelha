...
/* Fazendo um jogo: o jogo da velha, para o projeto de T√©cnicas e Desenvolvimento de Algortimos */
	...
	switch(numero){
		...
		do{
			...
			do{
				...
				do{
					printf("\n JOGADOR 1 = o\nJOGADOR 2 = x\n");
					printf("\nJOGADOR %d: Digite o n˙mero da linha e da coluna que queira jogar (com espaÁamento entre os n˙meros): ", jogador);
